#ifndef DST_MAIN_AST_RELATION_NODEISIGNORED_H
#define DST_MAIN_AST_RELATION_NODEISIGNORED_H

#include "DST_Main/Ast/Enum/Type.h"

namespace DST_Main { namespace ast { namespace relation { 

	constexpr static bool NodeIsIgnored(::DST_Main::ast::Type t)
	{
...
#endif // DST_MAIN_AST_RELATION_NODEISIGNORED_H