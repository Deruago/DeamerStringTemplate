#include "DST_Setting/Ast/Visualisation/Graph.h"
...
int main(int argc, const char* argv[])
{
	...
	for (const auto& filename : filenames)
	{
		...
		auto parser = DST_Setting::bison::parser::Parser();
		...
		if (true)
		{
			auto graph = DST_Setting::ast::listener::deamer::visualisation::Graph();
