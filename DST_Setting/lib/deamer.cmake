...
file(GLOB_RECURSE SOURCE_LIST "${DST_Setting_SOURCE_DIR}/lib/*.cpp")
file(GLOB_RECURSE HEADER_LIST "${DST_Setting_SOURCE_DIR}/include/*.h")

# Root library extension
DST_root_library_extend("DST_Setting" "${DST_Setting_SOURCE_DIR}/extern" "${DST_Setting_SOURCE_DIR}/include" "${SOURCE_LIST}")

add_library(DST_Setting_static_library ALIAS DST_static_library)