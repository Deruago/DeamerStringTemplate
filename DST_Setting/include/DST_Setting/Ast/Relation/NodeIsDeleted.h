#ifndef DST_SETTING_AST_RELATION_NODEISDELETED_H
#define DST_SETTING_AST_RELATION_NODEISDELETED_H

#include "DST_Setting/Ast/Enum/Type.h"

namespace DST_Setting { namespace ast { namespace relation { 

	constexpr static bool NodeIsDeleted(::DST_Setting::ast::Type t)
	{
...
#endif // DST_SETTING_AST_RELATION_NODEISDELETED_H