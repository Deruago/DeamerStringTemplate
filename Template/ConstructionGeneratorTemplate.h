#ifndef DST_TEST_CONSTRUCTIONTEMPLATE_h
#define DST_TEST_CONSTRUCTIONTEMPLATE_h
...
namespace DST::user
{
	 ...
	 *
	 *	\brief Generates code for "ConstructionTemplate"
	 *
	...
	public:
		...
		static constexpr const char* ConvertEnumToName(::DST::user::ConstructionTemplate::Type enumerationValue)
		{
			switch (enumerationValue)
			{
			case ::DST::user::ConstructionTemplate::Type::class_name_:
			{
				return "class_name";
			}

			case ::DST::user::ConstructionTemplate::Type::convert_enum_scope_to_name_:
			{
				return "convert_enum_scope_to_name";
			}

			case ::DST::user::ConstructionTemplate::Type::convert_enum_to_name_:
			{
				return "convert_enum_to_name";
			}

			case ::DST::user::ConstructionTemplate::Type::convert_enum_to_name_case_:
			{
				return "convert_enum_to_name_case";
			}

			case ::DST::user::ConstructionTemplate::Type::delete_member_:
			{
				return "delete_member";
			}

			case ::DST::user::ConstructionTemplate::Type::enum_:
			{
				return "enum";
			}

			case ::DST::user::ConstructionTemplate::Type::enum_scope_:
			{
				return "enum_scope";
			}

			case ::DST::user::ConstructionTemplate::Type::enum_scope_enumeration_:
			{
				return "enum_scope_enumeration";
			}

			case ::DST::user::ConstructionTemplate::Type::enum_scope_type_:
			{
				return "enum_scope_type";
			}

			case ::DST::user::ConstructionTemplate::Type::enum_type_:
			{
				return "enum_type";
			}

			case ::DST::user::ConstructionTemplate::Type::enumeration_:
			{
				return "enumeration";
			}

			case ::DST::user::ConstructionTemplate::Type::file_:
			{
				return "file";
			}

			case ::DST::user::ConstructionTemplate::Type::header_guard_:
			{
				return "header_guard";
			}

			case ::DST::user::ConstructionTemplate::Type::left_angle_bracket_:
			{
				return "left_angle_bracket";
			}

			case ::DST::user::ConstructionTemplate::Type::left_bracket_:
			{
				return "left_bracket";
			}

			case ::DST::user::ConstructionTemplate::Type::left_curly_bracket_:
			{
				return "left_curly_bracket";
			}

			case ::DST::user::ConstructionTemplate::Type::member_:
			{
				return "member";
			}

			case ::DST::user::ConstructionTemplate::Type::member_class_declaration_:
			{
				return "member_class_declaration";
			}

			case ::DST::user::ConstructionTemplate::Type::member_declaration_:
			{
				return "member_declaration";
			}

			case ::DST::user::ConstructionTemplate::Type::member_fields_:
			{
				return "member_fields";
			}

			case ::DST::user::ConstructionTemplate::Type::member_initialization_:
			{
				return "member_initialization";
			}

			case ::DST::user::ConstructionTemplate::Type::member_type_:
			{
				return "member_type";
			}

			case ::DST::user::ConstructionTemplate::Type::namespace_:
			{
				return "namespace";
			}

			case ::DST::user::ConstructionTemplate::Type::register_member_:
			{
				return "register_member";
			}

			case ::DST::user::ConstructionTemplate::Type::right_angle_bracket_:
			{
				return "right_angle_bracket";
			}

			case ::DST::user::ConstructionTemplate::Type::right_bracket_:
			{
				return "right_bracket";
			}

			case ::DST::user::ConstructionTemplate::Type::right_curly_bracket_:
			{
				return "right_curly_bracket";
			}

			case ::DST::user::ConstructionTemplate::Type::scope_:
			{
				return "scope";
			}

			case ::DST::user::ConstructionTemplate::Type::scope_arguments_:
			{
				return "scope_arguments";
			}

			case ::DST::user::ConstructionTemplate::Type::scope_assignment_:
			{
				return "scope_assignment";
			}

			case ::DST::user::ConstructionTemplate::Type::scope_field_:
			{
				return "scope_field";
			}

			case ::DST::user::ConstructionTemplate::Type::scope_function_:
			{
				return "scope_function";
			}

			case ::DST::user::ConstructionTemplate::Type::scope_initialize_:
			{
	...
	public:
		struct VariableBase
		{
			...
			::DST::user::ConstructionTemplate::Type type = ::DST::user::ConstructionTemplate::Type::Unknown;
		...
		{
			::DST::user::ConstructionTemplate::ScopeType scope_type = ::DST::user::ConstructionTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DST::user::ConstructionTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DST::user::ConstructionTemplate::Type::Scope;
			}

			VariableScope(const char* text, ::DST::user::ConstructionTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DST::user::ConstructionTemplate::Type::Scope;
			}

			VariableScope(std::vector<VariableBase*> variable, ::DST::user::ConstructionTemplate::ScopeType scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)
			{
				type = ::DST::user::ConstructionTemplate::Type::Scope;
			}
		};
		...
		{
			// Default scopes
			VariableBase* default_ = new VariableScope(::DST::user::ConstructionTemplate::ScopeType::Default_, true);
			VariableBase* upper_ = new VariableScope(::DST::user::ConstructionTemplate::ScopeType::Upper_, true);
			VariableBase* lower_ = new VariableScope(::DST::user::ConstructionTemplate::ScopeType::Lower_, true);
			VariableBase* variable_field_ = new VariableScope(::DST::user::ConstructionTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope("\n", ::DST::user::ConstructionTemplate::ScopeType::Variable_Field_Separator_, true);
	...
	public:
		...
		struct Variable_class_name_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::class_name_;
			}

			virtual ~Variable_class_name_() override = default;

			Variable_class_name_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::class_name_;
		...
		struct Variable_convert_enum_scope_to_name_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::convert_enum_scope_to_name_;
			}

			virtual ~Variable_convert_enum_scope_to_name_() override = default;

			Variable_convert_enum_scope_to_name_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::convert_enum_scope_to_name_;
		...
		struct Variable_convert_enum_to_name_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::convert_enum_to_name_;
			}

			virtual ~Variable_convert_enum_to_name_() override = default;

			Variable_convert_enum_to_name_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::convert_enum_to_name_;
		...
		struct Variable_convert_enum_to_name_case_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::convert_enum_to_name_case_;
			}

			virtual ~Variable_convert_enum_to_name_case_() override = default;

			Variable_convert_enum_to_name_case_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::convert_enum_to_name_case_;
		...
		struct Variable_delete_member_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::delete_member_;
			}

			virtual ~Variable_delete_member_() override = default;

			Variable_delete_member_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::delete_member_;
		...
		struct Variable_enum_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_;
			}

			virtual ~Variable_enum_() override = default;

			Variable_enum_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_;
		...
		struct Variable_enum_scope_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_scope_;
			}

			virtual ~Variable_enum_scope_() override = default;

			Variable_enum_scope_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_scope_;
		...
		struct Variable_enum_scope_enumeration_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_scope_enumeration_;
			}

			virtual ~Variable_enum_scope_enumeration_() override = default;

			Variable_enum_scope_enumeration_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_scope_enumeration_;
		...
		struct Variable_enum_scope_type_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_scope_type_;
			}

			virtual ~Variable_enum_scope_type_() override = default;

			Variable_enum_scope_type_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_scope_type_;
		...
		struct Variable_enum_type_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_type_;
			}

			virtual ~Variable_enum_type_() override = default;

			Variable_enum_type_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::enum_type_;
		...
		struct Variable_enumeration_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::enumeration_;
			}

			virtual ~Variable_enumeration_() override = default;

			Variable_enumeration_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::enumeration_;
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::file_;
			}

			virtual ~Variable_file_() override = default;

			Variable_file_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("#ifndef "), GenerateVariable(constructiontemplate_->header_guard_->This()), GenerateVariable("\n#define "), GenerateVariable(constructiontemplate_->header_guard_->This()), GenerateVariable("\n\n#include <variant>\n#include <vector>\n#include <string>\n\nnamespace "), GenerateVariable(constructiontemplate_->namespace_->This()), GenerateVariable("\n"), GenerateVariable("{"), GenerateVariable("\n\n\t/*!\t"), GenerateVariable("\\"), GenerateVariable("class "), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("\n\t *\n\t *\t"), GenerateVariable("\\"), GenerateVariable("brief Generates code for \""), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("\"\n\t *\n\t *\t"), GenerateVariable("\\"), GenerateVariable("details This is generated by DST"), GenerateVariable("."), GenerateVariable("\n\t *\tFor more information visit: https://github"), GenerateVariable("."), GenerateVariable("com/Deruago/DeamerStringTemplate\n\t */\n\tclass "), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("\n\t"), GenerateVariable("{"), GenerateVariable("\n\tpublic:\n\t\t"), GenerateVariable(constructiontemplate_->enum_->This()), GenerateVariable("\n\n\t\t"), GenerateVariable(constructiontemplate_->enum_scope_->This()), GenerateVariable("\n\n\t\t"), GenerateVariable(constructiontemplate_->convert_enum_to_name_->This()), GenerateVariable("\n\n\t\t"), GenerateVariable(constructiontemplate_->convert_enum_scope_to_name_->This()), GenerateVariable("\n\tpublic:\n\t\tstruct VariableBase\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t// The value is either a string\n\t\t\t// or a vector of variables"), GenerateVariable("."), GenerateVariable("\n\t\t\tstd::variant<std::string, std::vector<VariableBase*>> value;\n\t\t\tbool isString = true;\n\n\t\t\t"), GenerateVariable(constructiontemplate_->enum_type_->This()), GenerateVariable(" type = "), GenerateVariable(constructiontemplate_->enum_type_->This()), GenerateVariable("::Unknown;\n\n\t\t\tVariableBase() : VariableBase(std::vector<VariableBase*>())\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tvirtual ~VariableBase() = default;\n\n\t\t\tVariableBase(const char* text)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tisString = true;\n\t\t\t\tvalue = text;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase(const std::string& text)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tisString = true;\n\t\t\t\tvalue = text;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase(std::vector<VariableBase*> variables)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tisString = false;\n\t\t\t\tvalue = variables;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase* This()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn this;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tstd::string GetValue()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tif (isString)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\treturn std::get<std::string>(value);\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\t\telse\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tstd::string output;\n\t\t\t\t\tauto& variables = std::get<std::vector<VariableBase*>>(value);\n\t\t\t\t\tfor (auto* variable : variables)\n\t\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\t\toutput += variable->GetValue();\n\t\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\t\t\treturn output;\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tstd::string GetName()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn ConvertEnumToName(type);\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& operator=(const std::string& variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn Set(variable);\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& operator=(VariableBase* variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn Set(variable);\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& operator+=(VariableBase* variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn Add(variable);\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& operator+=(const std::string& variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn Add(variable);\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& Set(const std::string& variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tvalue = variable;\n\t\t\t\tisString = true;\n\n\t\t\t\treturn *this;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& Set(VariableBase* variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tif (variable == this)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\treturn *this;\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\t\tvalue = variable->value;\n\t\t\t\tisString = variable->isString;\n\n\t\t\t\treturn *this;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& Add(const std::string& variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tif (isString)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tauto& text = std::get<std::string>(value);\n\t\t\t\t\ttext += variable;\n\t\t\t\t\tvalue = text;\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\t\telse\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tauto& vector = std::get<std::vector<VariableBase*>>(value);\n\t\t\t\t\tvector"), GenerateVariable("."), GenerateVariable("push_back(new VariableBase(variable));\n\t\t\t\t\tvalue = vector;\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\t\treturn *this;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase& Add(VariableBase* variable)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tif (variable == this)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\treturn *this;\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\t\tif (isString)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\t// convert current -> variablebase\n\t\t\t\t\t// then create a vector"), GenerateVariable("."), GenerateVariable("\n\t\t\t\t\tauto& currentValue = std::get<std::string>(value);\n\t\t\t\t\tauto* currentValueAsVariableBase = new VariableBase(currentValue);\n\t\t\t\t\tvalue = std::vector<VariableBase*>("), GenerateVariable("{"), GenerateVariable(" currentValueAsVariableBase, variable "), GenerateVariable("}"), GenerateVariable(");\n\n\t\t\t\t\tisString = false;\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\t\telse\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tauto& vector = std::get<std::vector<VariableBase*>>(value);\n\t\t\t\t\tvector"), GenerateVariable("."), GenerateVariable("push_back(variable);\n\t\t\t\t\tvalue = vector;\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\t\treturn *this;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tvoid Clear()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tif (isString)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tvalue = \"\";\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\t\telse\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tvalue = std::vector<VariableBase*>();\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tvoid* operator new(size_t size)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tvoid* newVariable = ::operator new(size);\n\t\t\t\tvariables_to_delete"), GenerateVariable("."), GenerateVariable("emplace_back(static_cast<VariableBase*>(newVariable));\n\n\t\t\t\treturn newVariable;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t"), GenerateVariable("}"), GenerateVariable(";\n\n\t\tstatic VariableBase* GenerateVariable(VariableBase* variable)\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\treturn variable;\n\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\n\t\tstatic VariableBase* GenerateVariable(const std::string& variable)\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\treturn new VariableBase(variable);\n\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\tstruct VariableScope : public VariableBase\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t"), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable(" scope_type = "), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable("::Unknown;\n\t\t\tbool isReserved = false;\n\n\t\t\tVariableScope("), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable(" scope_type_, bool isReserved_ = false) : VariableBase(), scope_type(scope_type_), isReserved(isReserved_)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\ttype = "), GenerateVariable(constructiontemplate_->enum_type_->This()), GenerateVariable("::Scope;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableScope(const char* text, "), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable(" scope_type_, bool isReserved_ = false) : VariableBase(text), scope_type(scope_type_), isReserved(isReserved_)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\ttype = "), GenerateVariable(constructiontemplate_->enum_type_->This()), GenerateVariable("::Scope;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableScope(std::vector<VariableBase*> variable, "), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable(" scope_type_, bool isReserved_ = false) : VariableBase(variable), scope_type(scope_type_), isReserved(isReserved_)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\ttype = "), GenerateVariable(constructiontemplate_->enum_type_->This()), GenerateVariable("::Scope;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t"), GenerateVariable("}"), GenerateVariable(";\n\n\t\tstruct VariableScopes : public VariableBase\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t// Default scopes\n\t\t\tVariableBase* default_ = new VariableScope("), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable("::Default_, true);\n\t\t\tVariableBase* upper_ = new VariableScope("), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable("::Upper_, true);\n\t\t\tVariableBase* lower_ = new VariableScope("), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable("::Lower_, true);\n\t\t\tVariableBase* variable_field_ = new VariableScope("), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable("::Variable_Field_, true);\n\t\t\tVariableBase* variable_field_separator_ = new VariableScope(\""), GenerateVariable("\\"), GenerateVariable("n\", "), GenerateVariable(constructiontemplate_->enum_scope_type_->This()), GenerateVariable("::Variable_Field_Separator_, true);\n\n\t\t\t// Ctor\n\t\t\tVariableScopes() : VariableBase() "), GenerateVariable("{"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableScopes(const char* text) : VariableBase(text) "), GenerateVariable("{"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableScopes(const std::string& text) : VariableBase(text) "), GenerateVariable("{"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableScopes(std::vector<VariableBase*> variables) : VariableBase(variables) "), GenerateVariable("{"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\t// Dtor\n\t\t\tvirtual ~VariableScopes() override = default;\n\n\t\t\t// Calls\n\t\t\tVariableBase* Default()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn default_;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t\tVariableBase* Upper()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tstd::string upperVariant;\n\t\t\t\tstd::string currentValue = GetValue();\n\n\t\t\t\tfor (const auto character : currentValue)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tupperVariant += std::toupper(character);\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\t\t*upper_ = upperVariant;\n\n\t\t\t\treturn upper_;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase* Lower()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tstd::string lowerVariant;\n\t\t\t\tstd::string currentValue = GetValue();\n\n\t\t\t\tfor (const auto character : currentValue)\n\t\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t\tlowerVariant += std::tolower(character);\n\t\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\t\t*lower_ = lowerVariant;\n\n\t\t\t\treturn lower_;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase* Variable_Field()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn variable_field_;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tVariableBase* Variable_Field_Separator()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\treturn variable_field_separator_;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t\tvoid ExpandVariableField()\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\t// currentvalue + separator\n\t\t\t\tconst auto currentValue = GetValue() + Variable_Field_Separator()->GetValue();\n\t\t\t\t*Variable_Field() += currentValue;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t"), GenerateVariable("}"), GenerateVariable(";\n\n\tpublic:\n\t\t"), GenerateVariable(constructiontemplate_->member_class_declaration_->Variable_Field()), GenerateVariable("\n\n\tpublic:\n\t\tstatic std::vector<VariableBase*> variables_to_delete;\n\n\tpublic:\n\t\tstd::vector<VariableBase*> variables_;\n\n\tpublic:\n\t\t// Members that one can directly access"), GenerateVariable("."), GenerateVariable("\n\t\t// e"), GenerateVariable("."), GenerateVariable("g"), GenerateVariable("."), GenerateVariable(" "), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("."), GenerateVariable("member = \"auto-generated\";\n\t\t"), GenerateVariable(constructiontemplate_->member_declaration_->Variable_Field()), GenerateVariable("\n\n\tpublic:\n\t\t"), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("()\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t"), GenerateVariable(constructiontemplate_->member_initialization_->Variable_Field()), GenerateVariable("\n\n\t\t\t"), GenerateVariable(constructiontemplate_->register_member_->Variable_Field()), GenerateVariable("\n\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\tvirtual ~"), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("()\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\tfor(auto* variable : variables_to_delete)\n\t\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\t\tdelete variable;\n\t\t\t"), GenerateVariable("}"), GenerateVariable("\n\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\tpublic:\n\t\t// Default DST functions\n\n\t\t/*!\t"), GenerateVariable("\\"), GenerateVariable("fn GetOutput\n\t\t *\n\t\t *\t"), GenerateVariable("\\"), GenerateVariable("brief returns the output with the given the current state"), GenerateVariable("."), GenerateVariable("\n\t\t */\n\t\tstd::string GetOutput()\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\treturn file_->Content()->GetValue();\n\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\t\t/*!\t"), GenerateVariable("\\"), GenerateVariable("fn GetVariables\n\t\t *\n\t\t *\t"), GenerateVariable("\\"), GenerateVariable("brief Returns all top level variables known in this template"), GenerateVariable("."), GenerateVariable("\n\t\t */\n\t\tstd::vector<VariableBase*> GetVariables()\n\t\t"), GenerateVariable("{"), GenerateVariable("\n\t\t\treturn variables_;\n\t\t"), GenerateVariable("}"), GenerateVariable("\n\n\tpublic:\n\t"), GenerateVariable("}"), GenerateVariable(";\n\t\n\tstd::vector<"), GenerateVariable(constructiontemplate_->namespace_->This()), GenerateVariable("::"), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("::VariableBase*> "), GenerateVariable(constructiontemplate_->namespace_->This()), GenerateVariable("::"), GenerateVariable(constructiontemplate_->class_name_->This()), GenerateVariable("::variables_to_delete;\n\n"), GenerateVariable("}"), GenerateVariable("\n\n#endif // "), GenerateVariable(constructiontemplate_->header_guard_->This()) }));
				Content_->type = ::DST::user::ConstructionTemplate::Type::Scope;

				*static_cast<VariableBase*>(Class_prefix_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("Template") }));
				Class_prefix_->type = ::DST::user::ConstructionTemplate::Type::Scope;

				*static_cast<VariableBase*>(Extension_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("h") }));
				Extension_->type = ::DST::user::ConstructionTemplate::Type::Scope;

				*static_cast<VariableBase*>(File_name_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("Construction") }));
				File_name_->type = ::DST::user::ConstructionTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("DST::user") }));
				Namespace_->type = ::DST::user::ConstructionTemplate::Type::Scope;

				*static_cast<VariableBase*>(Target_language_) = VariableBase(std::vector<VariableBase*>({ GenerateVariable("C++") }));
				Target_language_->type = ::DST::user::ConstructionTemplate::Type::Scope;
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::header_guard_;
			}

			virtual ~Variable_header_guard_() override = default;

			Variable_header_guard_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::header_guard_;
		...
		struct Variable_left_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::left_angle_bracket_;
			}

			virtual ~Variable_left_angle_bracket_() override = default;

			Variable_left_angle_bracket_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::left_angle_bracket_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::left_bracket_;
			}

			virtual ~Variable_left_bracket_() override = default;

			Variable_left_bracket_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::left_bracket_;
		...
		struct Variable_left_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::left_curly_bracket_;
			}

			virtual ~Variable_left_curly_bracket_() override = default;

			Variable_left_curly_bracket_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::left_curly_bracket_;
		...
		struct Variable_member_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::member_;
			}

			virtual ~Variable_member_() override = default;

			Variable_member_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::member_;
		...
		struct Variable_member_class_declaration_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::member_class_declaration_;
			}

			virtual ~Variable_member_class_declaration_() override = default;

			Variable_member_class_declaration_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::member_class_declaration_;
		...
		struct Variable_member_declaration_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::member_declaration_;
			}

			virtual ~Variable_member_declaration_() override = default;

			Variable_member_declaration_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::member_declaration_;
		...
		struct Variable_member_fields_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::member_fields_;
			}

			virtual ~Variable_member_fields_() override = default;

			Variable_member_fields_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::member_fields_;
		...
		struct Variable_member_initialization_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::member_initialization_;
			}

			virtual ~Variable_member_initialization_() override = default;

			Variable_member_initialization_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::member_initialization_;
		...
		struct Variable_member_type_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::member_type_;
			}

			virtual ~Variable_member_type_() override = default;

			Variable_member_type_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::member_type_;
		...
		struct Variable_namespace_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::namespace_;
			}

			virtual ~Variable_namespace_() override = default;

			Variable_namespace_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::namespace_;
		...
		struct Variable_register_member_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::register_member_;
			}

			virtual ~Variable_register_member_() override = default;

			Variable_register_member_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::register_member_;
		...
		struct Variable_right_angle_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::right_angle_bracket_;
			}

			virtual ~Variable_right_angle_bracket_() override = default;

			Variable_right_angle_bracket_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::right_angle_bracket_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::right_bracket_;
			}

			virtual ~Variable_right_bracket_() override = default;

			Variable_right_bracket_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::right_bracket_;
		...
		struct Variable_right_curly_bracket_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::right_curly_bracket_;
			}

			virtual ~Variable_right_curly_bracket_() override = default;

			Variable_right_curly_bracket_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::right_curly_bracket_;
		...
		struct Variable_scope_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_;
			}

			virtual ~Variable_scope_() override = default;

			Variable_scope_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_;
		...
		struct Variable_scope_arguments_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_arguments_;
			}

			virtual ~Variable_scope_arguments_() override = default;

			Variable_scope_arguments_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_arguments_;
		...
		struct Variable_scope_assignment_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_assignment_;
			}

			virtual ~Variable_scope_assignment_() override = default;

			Variable_scope_assignment_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_assignment_;
		...
		struct Variable_scope_field_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_field_;
			}

			virtual ~Variable_scope_field_() override = default;

			Variable_scope_field_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_field_;
		...
		struct Variable_scope_function_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_function_;
			}

			virtual ~Variable_scope_function_() override = default;

			Variable_scope_function_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_function_;
		...
		struct Variable_scope_initialize_ : public VariableScopes
		{
			...
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_initialize_;
			}

			virtual ~Variable_scope_initialize_() override = default;

			Variable_scope_initialize_(ConstructionTemplate* constructiontemplate_, const std::vector<VariableBase*>& variables) : VariableScopes(variables)
			{
				type = ::DST::user::ConstructionTemplate::Type::scope_initialize_;
	...
	public:
		...
		// e.g. ConstructionTemplate.member = "auto-generated";
	...
	public:
		ConstructionTemplate()
		{
			...
			*member_ = Variable_member_(this, std::vector<VariableBase*>({ GenerateVariable("member_") }));
			...
			*member_fields_ = Variable_member_fields_(this, std::vector<VariableBase*>({ GenerateVariable("GenerateVariable(member_type_->This()), GenerateVariable(\"* \"), GenerateVariable(member_->This()), GenerateVariable(\" = new \"), GenerateVariable(member_type_->This()), GenerateVariable(\"();\")") }));
	...
	std::vector<DST::user::ConstructionTemplate::VariableBase*> DST::user::ConstructionTemplate::variables_to_delete;

}

#endif // DST_TEST_CONSTRUCTIONTEMPLATE_h
