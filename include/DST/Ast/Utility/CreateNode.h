#ifndef DST_AST_UTILITY_CREATENODE_H
#define DST_AST_UTILITY_CREATENODE_H
...
namespace DST { namespace ast { namespace utility { 
	...
	public:
		...
		{
			switch(static_cast<::DST::ast::Type>(nodeType))
			{
			case ::DST::ast::Type::deamerreserved_unknown: {
			...
			case ::DST::ast::Type::ANY: {
				return new ::DST::ast::node::ANY({nodeType, ::deamer::external::cpp::ast::NodeValue::terminal, nodeValue, lineNumber, columnNumber});
			}
			case ::DST::ast::Type::program: {
				return new ::DST::ast::node::program({nodeType, ::deamer::external::cpp::ast::NodeValue::nonterminal, {productionRuleId, productionRuleType}}, nodes);
			}
			case ::DST::ast::Type::deamerreserved_star__ANY__: {
				return new ::DST::ast::node::deamerreserved_star__ANY__({nodeType, ::deamer::external::cpp::ast::NodeValue::nonterminal, {productionRuleId, productionRuleType}}, nodes);
			}
...
#endif // DST_AST_UTILITY_CREATENODE_H