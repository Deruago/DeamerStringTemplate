...
namespace DST::user
{
	...
	public:
		...
		ConvertEnumToName(::DST::user::ConstructionGeneratorTemplate::Type enumerationValue)
		{
	...
	public:
		struct VariableBase
		{
			...
			::DST::user::ConstructionGeneratorTemplate::Type type =
				::DST::user::ConstructionGeneratorTemplate::Type::Unknown;
		...
		{
			::DST::user::ConstructionGeneratorTemplate::ScopeType scope_type =
				::DST::user::ConstructionGeneratorTemplate::ScopeType::Unknown;
			bool isReserved = false;

			VariableScope(::DST::user::ConstructionGeneratorTemplate::ScopeType scope_type_,
			...
			VariableScope(const char* text,
						  ::DST::user::ConstructionGeneratorTemplate::ScopeType scope_type_,
						  bool isReserved_ = false)
				: VariableBase(text),
				  scope_type(scope_type_),
				  isReserved(isReserved_)
		...
		struct Variable_ReservedScope_Upper : public VariableScope
		{
			...
			Variable_ReservedScope_Upper(VariableBase* base_)
				: VariableScope(::DST::user::ConstructionGeneratorTemplate::ScopeType::Upper_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Lower : public VariableScope
		{
			...
			Variable_ReservedScope_Lower(VariableBase* base_)
				: VariableScope(::DST::user::ConstructionGeneratorTemplate::ScopeType::Lower_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Snake : public VariableScope
		{
			...
			Variable_ReservedScope_Snake(VariableBase* base_)
				: VariableScope(::DST::user::ConstructionGeneratorTemplate::ScopeType::Snake_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_Slash : public VariableScope
		{
			...
			Variable_ReservedScope_Slash(VariableBase* base_)
				: VariableScope(::DST::user::ConstructionGeneratorTemplate::ScopeType::Slash_,
								true),
				  base(base_)
			{
			}
		...
		struct Variable_ReservedScope_DoubleColon : public VariableScope
		{
			...
			Variable_ReservedScope_DoubleColon(VariableBase* base_)
				: VariableScope(::DST::user::ConstructionGeneratorTemplate::ScopeType::DoubleColon_,
								true),
				  base(base_)
			{
			}
		...
		struct VariableScopes : public VariableBase
		{
			...
			VariableBase* default_ = new VariableScope(
				::DST::user::ConstructionGeneratorTemplate::ScopeType::Default_, true);
			...
			VariableBase* variable_field_ = new VariableScope(
				::DST::user::ConstructionGeneratorTemplate::ScopeType::Variable_Field_, true);
			VariableBase* variable_field_separator_ = new VariableScope(
				"\n",
				::DST::user::ConstructionGeneratorTemplate::ScopeType::Variable_Field_Separator_,
				true);
	...
	public:
		struct Variable_class_name_ : public VariableScopes
		{
			...
			Variable_class_name_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
		...
		struct Variable_convert_enum_scope_to_name_ : public VariableScopes
		{
			...
			{
				type =
					::DST::user::ConstructionGeneratorTemplate::Type::convert_enum_scope_to_name_;
			}

			virtual ~Variable_convert_enum_scope_to_name_() override = default;

			Variable_convert_enum_scope_to_name_(
				ConstructionGeneratorTemplate* constructiongeneratortemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type =
			...
			Variable_convert_enum_scope_to_name_&
			operator=(const Variable_convert_enum_scope_to_name_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_convert_enum_to_name_ : public VariableScopes
		{
			...
			Variable_convert_enum_to_name_(
				ConstructionGeneratorTemplate* constructiongeneratortemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_convert_enum_to_name_&
			operator=(const Variable_convert_enum_to_name_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_convert_enum_to_name_case_ : public VariableScopes
		{
			...
			Variable_convert_enum_to_name_case_(
				ConstructionGeneratorTemplate* constructiongeneratortemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_convert_enum_to_name_case_&
			operator=(const Variable_convert_enum_to_name_case_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_delete_member_ : public VariableScopes
		{
			...
			Variable_delete_member_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::delete_member_;
		...
		struct Variable_enum_ : public VariableScopes
		{
			...
			Variable_enum_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::enum_;
		...
		struct Variable_enum_scope_ : public VariableScopes
		{
			...
			Variable_enum_scope_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::enum_scope_;
		...
		struct Variable_enum_scope_enumeration_ : public VariableScopes
		{
			...
			Variable_enum_scope_enumeration_(
				ConstructionGeneratorTemplate* constructiongeneratortemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_enum_scope_enumeration_&
			operator=(const Variable_enum_scope_enumeration_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_enum_scope_type_ : public VariableScopes
		{
			...
			Variable_enum_scope_type_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::enum_scope_type_;
		...
		struct Variable_enum_type_ : public VariableScopes
		{
			...
			Variable_enum_type_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::enum_type_;
		...
		struct Variable_enumeration_ : public VariableScopes
		{
			...
			Variable_enumeration_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::enumeration_;
		...
		struct Variable_file_ : public VariableScopes
		{
			...
			Variable_file_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
						   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::file_;
				*static_cast<VariableBase*>(Content_) = VariableBase(std::vector<VariableBase*>(
					{GenerateVariable("#ifndef "),
					 GenerateVariable(constructiongeneratortemplate_->header_guard_->This()),
					 GenerateVariable("\r\n#define "),
					 GenerateVariable(constructiongeneratortemplate_->header_guard_->This()),
					 GenerateVariable("\r\n\r\n#include <variant>\r\n#include <vector>\r\n#include "
									  "<string>\r\n\r\nnamespace "),
					 GenerateVariable(constructiongeneratortemplate_->namespace_->This()),
					 GenerateVariable("\r\n"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\r\n\t/*!\t"),
					 GenerateVariable("\\"),
					 GenerateVariable("class "),
					 GenerateVariable(constructiongeneratortemplate_->class_name_->This()),
					 GenerateVariable("\r\n\t *\r\n\t *\t"),
					 GenerateVariable("\\"),
					 GenerateVariable("brief Generates code for \""),
					 GenerateVariable(constructiongeneratortemplate_->class_name_->This()),
					 GenerateVariable("\"\r\n\t *\r\n\t *\t"),
					 GenerateVariable("\\"),
					 GenerateVariable("details This is generated by DST"),
					 GenerateVariable("."),
					 GenerateVariable("\r\n\t *\tFor more information visit: https://github"),
					 GenerateVariable("."),
					 GenerateVariable("com/Deruago/DeamerStringTemplate\r\n\t */\r\n\tclass "),
					 GenerateVariable(constructiongeneratortemplate_->class_name_->This()),
					 GenerateVariable("\r\n\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\tpublic:\r\n\t\t"),
					 GenerateVariable(constructiongeneratortemplate_->enum_->This()),
					 GenerateVariable("\r\n\r\n\t\t"),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_->This()),
					 GenerateVariable("\r\n\r\n\t\t"),
					 GenerateVariable(
						 constructiongeneratortemplate_->convert_enum_to_name_->This()),
					 GenerateVariable("\r\n\r\n\t\t"),
					 GenerateVariable(
						 constructiongeneratortemplate_->convert_enum_scope_to_name_->This()),
					 GenerateVariable("\r\n\tpublic:\r\n\t\tstruct VariableBase\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t// The value is either a string\r\n\t\t\t// or a "
									  "vector of variables"),
					 GenerateVariable("."),
					 GenerateVariable(
						 "\r\n\t\t\tstd::variant<std::string, std::vector<VariableBase*>> "
						 "value;\r\n\t\t\tbool isString = true;\r\n\r\n\t\t\t"),
					 GenerateVariable(constructiongeneratortemplate_->enum_type_->This()),
					 GenerateVariable(" type = "),
					 GenerateVariable(constructiongeneratortemplate_->enum_type_->This()),
					 GenerateVariable("::Unknown;\r\n\r\n\t\t\tVariableBase() : "
					 ...
					 GenerateVariable(
						 "\r\n\t\t\t\t\tstd::string output;\r\n\t\t\t\t\tauto& variables = "
						 "std::get<std::vector<VariableBase*>>(value);\r\n\t\t\t\t\tfor (auto* "
						 "variable : variables)\r\n\t\t\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable(
						 "\r\n\t\t\t\t\t\toutput += variable->GetValue();\r\n\t\t\t\t\t"),
					 ...
					 GenerateVariable("\r\n\t\t\t\treturn ConvertEnumToName(type);\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\t\tVariableBase& operator=(const std::string& "
									  "variable)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t\treturn Set(variable);\r\n\t\t\t"),
					 GenerateVariable("}"),
					 ...
					 GenerateVariable(
						 ...
						 "std::get<std::vector<VariableBase*>>(value);\r\n\t\t\t\t\tvector"),
					 GenerateVariable("."),
					 GenerateVariable("push_back(new VariableBase(variable));\r\n\t\t\t\t\tvalue = "
									  "vector;\r\n\t\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\t\t\treturn *this;\r\n\t\t\t"),
					 GenerateVariable("}"),
					 ...
					 GenerateVariable("\r\n\t\t\t\t\tauto& currentValue = "
									  "std::get<std::string>(value);\r\n\t\t\t\t\tauto* "
									  "currentValueAsVariableBase = new "
									  "VariableBase(currentValue);\r\n\t\t\t\t\tvalue = "
									  "std::vector<VariableBase*>("),
					 GenerateVariable("{"),
					 GenerateVariable(" currentValueAsVariableBase, variable "),
					 GenerateVariable("}"),
					 GenerateVariable(");\r\n\r\n\t\t\t\t\tisString = false;\r\n\t\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\t\t\t\telse\r\n\t\t\t\t"),
					 ...
					 GenerateVariable("\r\n\r\n\t\t\tvoid* operator new(size_t size)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t\tvoid* newVariable = ::operator "
									  "new(size);\r\n\t\t\t\tvariables_to_delete"),
					 GenerateVariable("."),
					 GenerateVariable("emplace_back(static_cast<VariableBase*>(newVariable));"
									  "\r\n\r\n\t\t\t\treturn newVariable;\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\r\n\r\n\t\tstatic VariableBase* "
									  "GenerateVariable(VariableBase* variable)\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\treturn variable;\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\t\r\n\t\tstatic VariableBase* "
									  "GenerateVariable(const std::string& variable)\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\treturn new VariableBase(variable);\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t"),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable(" scope_type = "),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::Unknown;\r\n\t\t\tbool isReserved = "
									  "false;\r\n\r\n\t\t\tVariableScope("),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable(" scope_type_, bool isReserved_ = false) : VariableBase(), "
									  "scope_type(scope_type_), isReserved(isReserved_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t\ttype = "),
					 GenerateVariable(constructiongeneratortemplate_->enum_type_->This()),
					 GenerateVariable("::Scope;\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\t\tVariableScope(const char* text, "),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable(
						 " scope_type_, bool isReserved_ = false) : VariableBase(text), "
						 "scope_type(scope_type_), isReserved(isReserved_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t\ttype = "),
					 GenerateVariable(constructiongeneratortemplate_->enum_type_->This()),
					 ...
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable(
						 " scope_type_, bool isReserved_ = false) : VariableBase(variable), "
						 "scope_type(scope_type_), isReserved(isReserved_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t\ttype = "),
					 GenerateVariable(constructiongeneratortemplate_->enum_type_->This()),
					 ...
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\r\n\t\t\r\n\t\tstruct Variable_ReservedScope_Upper : "
									  "public VariableScope\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\tVariableBase* "
									  "base;\r\n\t\t\tVariable_ReservedScope_Upper(VariableBase* "
									  "base_)\r\n\t\t\t: VariableScope("),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::Upper_, true),\r\n\t\t\t  base(base_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\r\n\t\t\r\n\t\tstruct Variable_ReservedScope_Lower : "
									  "public VariableScope\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\tVariableBase* "
									  "base;\r\n\t\t\tVariable_ReservedScope_Lower(VariableBase* "
									  "base_)\r\n\t\t\t: VariableScope("),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::Lower_, true),\r\n\t\t\t  base(base_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\r\n\t\t\r\n\t\tstruct Variable_ReservedScope_Snake : "
									  "public VariableScope\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\tVariableBase* "
									  "base;\r\n\t\t\tVariable_ReservedScope_Snake(VariableBase* "
									  "base_)\r\n\t\t\t: VariableScope("),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::Snake_, true),\r\n\t\t\t  base(base_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable(
						 ...
						 "tail\r\n\t\t\t\tif (!snakeVariant"),
					 GenerateVariable("."),
					 GenerateVariable("empty() && lastWasNonAlpha)\r\n\t\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t\t\tsnakeVariant"),
					 GenerateVariable("."),
					 ...
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\r\n\t\t\r\n\t\tstruct Variable_ReservedScope_Slash : "
									  "public VariableScope\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\tVariableBase* "
									  "base;\r\n\t\t\tVariable_ReservedScope_Slash(VariableBase* "
									  "base_)\r\n\t\t\t: VariableScope("),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::Slash_, true),\r\n\t\t\t  base(base_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\r\n\t\t\r\n\t\tstruct Variable_ReservedScope_DoubleColon "
									  ": public VariableScope\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\tVariableBase* "
									  "base;\r\n\t\t\tVariable_ReservedScope_DoubleColon("
									  "VariableBase* base_)\r\n\t\t\t: VariableScope("),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::DoubleColon_, true),\r\n\t\t\t  base(base_)\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable(
						 "::Default_, true);\r\n\t\t\tVariableBase* upper_ = new "
						 "Variable_ReservedScope_Upper(this);\r\n\t\t\tVariableBase* lower_ = new "
						 "Variable_ReservedScope_Lower(this);\r\n\t\t\t\r\n\t\t\tVariableBase* "
						 "snake_ = new Variable_ReservedScope_Snake(this);\r\n\t\t\tVariableBase* "
						 "slash_ = new Variable_ReservedScope_Slash(this);\r\n\t\t\tVariableBase* "
						 "double_colon_ = new "
						 "Variable_ReservedScope_DoubleColon(this);"
						 "\r\n\t\t\t\r\n\t\t\tVariableBase* variable_field_ = new VariableScope("),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::Variable_Field_, true);\r\n\t\t\tVariableBase* "
									  "variable_field_separator_ = new VariableScope(\""),
					 GenerateVariable("\\"),
					 GenerateVariable("n\", "),
					 GenerateVariable(constructiongeneratortemplate_->enum_scope_type_->This()),
					 GenerateVariable("::Variable_Field_Separator_, true);\r\n\r\n\t\t\t// "
									  "Ctor\r\n\t\t\tVariableScopes() : VariableBase() "),
					 GenerateVariable("{"),
					 GenerateVariable("}"),
					 GenerateVariable(
					 ...
					 GenerateVariable("{"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\t\tVariableScopes(const std::string& text) : "
									  "VariableBase(text) "),
					 GenerateVariable("{"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\t\tVariableScopes(std::vector<VariableBase*> "
									  "variables) : VariableBase(variables) "),
					 GenerateVariable("{"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\t\t// Dtor\r\n\t\t\tvirtual ~VariableScopes() "
									  "override = default;\r\n\r\n\t\t\t// "
									  "Calls\r\n\t\t\tVariableBase* Default()\r\n\t\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t\treturn default_;\r\n\t\t\t"),
					 ...
					 GenerateVariable("\r\n\t\t\t\t// currentvalue + separator\r\n\t\t\t\tconst "
									  ...
									  "Variable_Field_Separator()->GetValue();\r\n\t\t\t\t*"
									  "Variable_Field() += currentValue;\r\n\t\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable(";\r\n\r\n\tpublic:\r\n\t\t"),
					 GenerateVariable(constructiongeneratortemplate_->member_class_declaration_
										  ->Variable_Field()),
					 GenerateVariable(
						 "\r\n\r\n\tpublic:\r\n\t\tinline static std::vector<VariableBase*> "
						 "variables_to_delete = "
						 "std::vector<VariableBase*>();\r\n\r\n\tpublic:\r\n\t\tstd::vector<"
						 "VariableBase*> variables_;\r\n\r\n\tpublic:\r\n\t\t// Members that one "
						 "can directly access"),
					 GenerateVariable("."),
					 GenerateVariable("\r\n\t\t// e"),
					 GenerateVariable("."),
					 ...
					 GenerateVariable(constructiongeneratortemplate_->class_name_->This()),
					 GenerateVariable("."),
					 GenerateVariable("member = \"auto-generated\";\r\n\t\t"),
					 GenerateVariable(
						 constructiongeneratortemplate_->member_declaration_->Variable_Field()),
					 GenerateVariable("\r\n\r\n\tpublic:\r\n\t\t"),
					 GenerateVariable(constructiongeneratortemplate_->class_name_->This()),
					 GenerateVariable("()\r\n\t\t"),
					 GenerateVariable("{"),
					 GenerateVariable("\r\n\t\t\t"),
					 GenerateVariable(
						 constructiongeneratortemplate_->member_initialization_->Variable_Field()),
					 GenerateVariable("\r\n\r\n\t\t\t"),
					 GenerateVariable(
						 constructiongeneratortemplate_->register_member_->Variable_Field()),
					 GenerateVariable("\r\n\t\t"),
					 GenerateVariable("}"),
					 GenerateVariable("\r\n\r\n\t\tvirtual ~"),
					 GenerateVariable(constructiongeneratortemplate_->class_name_->This()),
					 ...
					 GenerateVariable("\\"),
					 GenerateVariable("brief returns the output with the given the current state"),
					 GenerateVariable("."),
					 ...
					 GenerateVariable("\r\n\r\n\t\t/*!\t"),
					 GenerateVariable("\\"),
					 GenerateVariable("fn GetVariables\r\n\t\t *\r\n\t\t *\t"),
					 GenerateVariable("\\"),
					 GenerateVariable(
				...
				*static_cast<VariableBase*>(Class_postfix_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("Template")}));
				...
				*static_cast<VariableBase*>(File_name_) = VariableBase(
					std::vector<VariableBase*>({GenerateVariable("ConstructionGenerator")}));
				File_name_->type = ::DST::user::ConstructionGeneratorTemplate::Type::Scope;

				*static_cast<VariableBase*>(Namespace_) =
					VariableBase(std::vector<VariableBase*>({GenerateVariable("DST::user")}));
		...
		struct Variable_header_guard_ : public VariableScopes
		{
			...
			Variable_header_guard_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::header_guard_;
		...
		struct Variable_left_bracket_ : public VariableScopes
		{
			...
			Variable_left_bracket_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								   const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::left_bracket_;
		...
		struct Variable_member_ : public VariableScopes
		{
			...
			Variable_member_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
							 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::member_;
		...
		struct Variable_member_class_declaration_ : public VariableScopes
		{
			...
			Variable_member_class_declaration_(
				ConstructionGeneratorTemplate* constructiongeneratortemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_member_class_declaration_&
			operator=(const Variable_member_class_declaration_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_member_fields_ : public VariableScopes
		{
			...
			Variable_member_fields_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::member_fields_;
		...
		struct Variable_member_initialization_ : public VariableScopes
		{
			...
			Variable_member_initialization_(
				ConstructionGeneratorTemplate* constructiongeneratortemplate_,
				const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
			...
			Variable_member_initialization_&
			operator=(const Variable_member_initialization_& variable)
			{
				if (&variable == this)
				{
					return *this;
		...
		struct Variable_member_type_ : public VariableScopes
		{
			...
			Variable_member_type_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::member_type_;
		...
		struct Variable_namespace_ : public VariableScopes
		{
			...
			Variable_namespace_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::namespace_;
		...
		struct Variable_namespace_upper_ : public VariableScopes
		{
			...
			Variable_namespace_upper_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::namespace_upper_;
		...
		struct Variable_register_member_ : public VariableScopes
		{
			...
			Variable_register_member_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::register_member_;
		...
		struct Variable_right_bracket_ : public VariableScopes
		{
			...
			Variable_right_bracket_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::right_bracket_;
		...
		struct Variable_scope_ : public VariableScopes
		{
			...
			Variable_scope_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
							const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::scope_;
		...
		struct Variable_scope_arguments_ : public VariableScopes
		{
			...
			Variable_scope_arguments_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::scope_arguments_;
		...
		struct Variable_scope_field_ : public VariableScopes
		{
			...
			Variable_scope_field_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
								  const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::scope_field_;
		...
		struct Variable_scope_function_ : public VariableScopes
		{
			...
			Variable_scope_function_(ConstructionGeneratorTemplate* constructiongeneratortemplate_,
									 const std::vector<VariableBase*>& variables)
				: VariableScopes(variables)
			{
				type = ::DST::user::ConstructionGeneratorTemplate::Type::scope_function_;
	...
	public:
		...
		Variable_convert_enum_scope_to_name_* convert_enum_scope_to_name_ =
			new Variable_convert_enum_scope_to_name_();
		Variable_convert_enum_to_name_* convert_enum_to_name_ =
			new Variable_convert_enum_to_name_();
		Variable_convert_enum_to_name_case_* convert_enum_to_name_case_ =
			new Variable_convert_enum_to_name_case_();
		...
		Variable_enum_scope_enumeration_* enum_scope_enumeration_ =
			new Variable_enum_scope_enumeration_();
		...
		Variable_member_class_declaration_* member_class_declaration_ =
			new Variable_member_class_declaration_();
		...
		Variable_member_initialization_* member_initialization_ =
			new Variable_member_initialization_();
	...
	public:
		ConstructionGeneratorTemplate()
		{
			*class_name_ = Variable_class_name_(
				this, std::vector<VariableBase*>({GenerateVariable(file_->File_name()),
												  GenerateVariable(file_->Class_postfix())}));
			*convert_enum_scope_to_name_ =
				Variable_convert_enum_scope_to_name_(this, std::vector<VariableBase*>({}));
			*convert_enum_to_name_ = Variable_convert_enum_to_name_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("static constexpr const char* ConvertEnumToName("),
						   GenerateVariable(enum_type_->This()),
						   GenerateVariable(" enumerationValue)\r\n"),
						   GenerateVariable("{"),
						   GenerateVariable("\r\n\tswitch(enumerationValue)\r\n\t"),
						   GenerateVariable("{"),
						   GenerateVariable("\r\n\tcase "),
						   GenerateVariable(enum_type_->This()),
						   GenerateVariable("::Unknown: {\r\n"),
						   GenerateVariable("\t\treturn \"Unknown\";}\r\n"),
						   GenerateVariable("\r\n\tcase "),
						   GenerateVariable(enum_type_->This()),
						   GenerateVariable("::Scope: {\r\n"),
						   GenerateVariable("\t\treturn \"Scope\";}\r\n"),
						   GenerateVariable("\r\n\t"),
						   GenerateVariable(convert_enum_to_name_case_->Variable_Field()),
						   GenerateVariable("\r\n\t"),
						   GenerateVariable("}"),
						   GenerateVariable("\r\n\r\n\treturn \"\";\r\n"),
						   GenerateVariable("}"),
						   GenerateVariable("\r\n")}));
			*convert_enum_to_name_case_ = Variable_convert_enum_to_name_case_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("case "), GenerateVariable(enum_type_->This()),
						   GenerateVariable("::"), GenerateVariable(member_->This()),
						   GenerateVariable("_:\r\n"), GenerateVariable("{"),
						   GenerateVariable("\r\n\treturn \""), GenerateVariable(member_->This()),
						   GenerateVariable("\";\r\n"), GenerateVariable("}"),
						   GenerateVariable("\r\n")}));
			*delete_member_ = Variable_delete_member_(
				this, std::vector<VariableBase*>({GenerateVariable("delete "),
												  GenerateVariable(member_->This()),
												  GenerateVariable(";")}));
			*enum_ = Variable_enum_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("enum class Type\r\n"), GenerateVariable("{"),
					 GenerateVariable("\r\nUnknown,\r\nScope,\r\n\r\n// User defined types\r\n"),
					 GenerateVariable(enumeration_->Variable_Field()), GenerateVariable("\r\n\r\n"),
					 GenerateVariable("}"), GenerateVariable(";\r\n")}));
			*enum_scope_ = Variable_enum_scope_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("enum class ScopeType\r\n"), GenerateVariable("{"),
					 GenerateVariable("\r\nUnknown,\r\n\r\n// "
									  "Default\r\nDefault_,\r\nUpper_,\r\nLower_,\r\n\r\nSnake_,"
									  "\r\nSlash_,\r\nBackSlash_,\r\nColon_,\r\nDoubleColon_,"
									  "\r\n\r\nVariable_Field_,\r\nVariable_Field_Separator_,"
									  "\r\nFunction_Field_,\r\nFunction_Field_Separator_,\r\n\r\n"),
					 GenerateVariable(enum_scope_enumeration_->Variable_Field()),
					 GenerateVariable("\r\n"), GenerateVariable("}"), GenerateVariable(";\r\n")}));
			*enum_scope_enumeration_ = Variable_enum_scope_enumeration_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(scope_->This()), GenerateVariable("_,")}));
			*enum_scope_type_ = Variable_enum_scope_type_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("::"), GenerateVariable(namespace_->This()),
						   GenerateVariable("::"), GenerateVariable(class_name_->This()),
						   GenerateVariable("::ScopeType")}));
			*enum_type_ = Variable_enum_type_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("::"), GenerateVariable(namespace_->This()),
						   GenerateVariable("::"), GenerateVariable(class_name_->This()),
						   GenerateVariable("::Type")}));
			*enumeration_ = Variable_enumeration_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(member_->This()), GenerateVariable("_,")}));
			*file_ = Variable_file_(this, std::vector<VariableBase*>({}));
			*header_guard_ = Variable_header_guard_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(namespace_upper_->Underscore()), GenerateVariable("_"),
						   GenerateVariable(class_name_->Upper()), GenerateVariable("_"),
						   GenerateVariable(file_->Extension())}));
			...
			*member_class_declaration_ = Variable_member_class_declaration_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("\r\nstruct "),
						   GenerateVariable(member_type_->This()),
						   GenerateVariable(" : public VariableScopes\r\n"),
						   GenerateVariable("{"),
						   GenerateVariable("\r\n\r\nstatic constexpr auto name = \""),
						   GenerateVariable(member_->This()),
						   GenerateVariable("\";\r\n\r\n"),
						   GenerateVariable(scope_field_->Variable_Field()),
						   GenerateVariable("\r\n\r\n"),
						   GenerateVariable(member_type_->This()),
						   GenerateVariable("() : VariableScopes()\r\n"),
						   GenerateVariable("{"),
						   GenerateVariable("\r\n\ttype = "),
						   GenerateVariable(enum_type_->This()),
						   GenerateVariable("::"),
						   ...
						   GenerateVariable("\r\n\r\nvirtual ~"),
						   GenerateVariable(member_type_->This()),
						   GenerateVariable("() override = default;\r\n\r\n"),
						   GenerateVariable(member_type_->This()),
						   GenerateVariable("("),
						   GenerateVariable(class_name_->This()),
						   GenerateVariable("* "),
						   GenerateVariable(class_name_->Lower()),
						   GenerateVariable("_, const std::vector<VariableBase*"),
						   GenerateVariable(right_angle_bracket_->This()),
						   GenerateVariable("& variables) : VariableScopes(variables)\r\n"),
						   GenerateVariable("{"),
						   GenerateVariable("\r\ntype = "),
						   GenerateVariable(enum_type_->This()),
						   GenerateVariable("::"),
						   GenerateVariable(member_->This()),
						   GenerateVariable(";\r\n"),
						   GenerateVariable(scope_initialize_->Variable_Field()),
						   GenerateVariable("\r\n"),
						   GenerateVariable("}"),
						   GenerateVariable("\r\n\r\n"),
						   GenerateVariable(scope_function_->Variable_Field()),
						   GenerateVariable("\r\n\r\n"),
						   GenerateVariable(member_type_->This()),
						   ...
						   GenerateVariable("."),
						   GenerateVariable("isString;\r\n\r\n\t"),
						   GenerateVariable(scope_assignment_->Variable_Field()),
						   GenerateVariable("\r\n\r\n\treturn *this;\r\n"),
						   GenerateVariable("}"),
						   GenerateVariable("\r\n\r\n"),
						   GenerateVariable("}"),
						   GenerateVariable(";")}));
			*member_declaration_ = Variable_member_declaration_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable(member_type_->This()), GenerateVariable("* "),
						   GenerateVariable(member_->This()), GenerateVariable(" = new "),
						   GenerateVariable(member_type_->This()), GenerateVariable("();")}));
			*member_fields_ = Variable_member_fields_(this, std::vector<VariableBase*>({}));
			*member_initialization_ = Variable_member_initialization_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("*"), GenerateVariable(member_->This()),
						   GenerateVariable(" = "), GenerateVariable(member_type_->This()),
						   GenerateVariable("(this, std::vector<VariableBase*"),
						   GenerateVariable(right_angle_bracket_->This()), GenerateVariable("("),
						   GenerateVariable("{"), GenerateVariable(" "),
						   GenerateVariable(member_fields_->This()), GenerateVariable(" "),
						   GenerateVariable("}"), GenerateVariable("));")}));
			*member_type_ = Variable_member_type_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("Variable_"), GenerateVariable(member_->This())}));
			*namespace_ = Variable_namespace_(
				this, std::vector<VariableBase*>({GenerateVariable(file_->Namespace())}));
			*namespace_upper_ = Variable_namespace_upper_(
				this, std::vector<VariableBase*>({GenerateVariable(namespace_->Upper())}));
			*register_member_ = Variable_register_member_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("variables_"), GenerateVariable("."),
						   GenerateVariable("emplace_back("), GenerateVariable(member_->This()),
						   GenerateVariable("_);")}));
			...
			*scope_assignment_ = Variable_scope_assignment_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("*"), GenerateVariable(scope_->This()),
						   GenerateVariable("_ = *variable"), GenerateVariable("."),
						   GenerateVariable(scope_->This()), GenerateVariable("_;")}));
			*scope_field_ = Variable_scope_field_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("VariableBase* "), GenerateVariable(scope_->This()),
						   GenerateVariable("_ = GenerateVariable(\"\");")}));
			*scope_function_ = Variable_scope_function_(
				this, std::vector<VariableBase*>(
						  {GenerateVariable("\r\nVariableBase* "), GenerateVariable(scope_->This()),
						   GenerateVariable("() const\r\n"), GenerateVariable("{"),
						   GenerateVariable("\r\n\treturn "), GenerateVariable(scope_->This()),
						   GenerateVariable("_;\r\n"), GenerateVariable("}")}));
			*scope_initialize_ = Variable_scope_initialize_(
				this,
				std::vector<VariableBase*>(
					{GenerateVariable("*static_cast<VariableBase*"),
					 GenerateVariable(right_angle_bracket_->This()), GenerateVariable("("),
					 GenerateVariable(scope_->This()),
					 GenerateVariable("_) = VariableBase(std::vector<VariableBase*"),
					 GenerateVariable(right_angle_bracket_->This()), GenerateVariable("("),
					 GenerateVariable("{"), GenerateVariable(" "),
					 GenerateVariable(scope_arguments_->This()), GenerateVariable(" "),
					 GenerateVariable("}"), GenerateVariable("));\r\n"),
					 GenerateVariable(scope_->This()), GenerateVariable("_-"),
					 GenerateVariable(right_angle_bracket_->This()), GenerateVariable("type = "),
					 GenerateVariable(enum_type_->This()), GenerateVariable("::Scope;\r\n")}));
